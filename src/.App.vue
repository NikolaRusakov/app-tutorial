<template>
	<div id="content" class="app-notestutorial">
		...
		<NcAppNavigation>
			<NcAppNavigationNew v-if="!loading" :text="t('notestutorial', 'New note')" :disabled="false"
...
// 		NcAppNavigationItem,
// 		NcAppNavigationNew,
// 		// SimpleInput: applyPureReactInVue(ReactSimpleInput)
// 	},
// 	setup() {
// 		function onClickForReact() {
// 			console.log('clicked!')
// 		}
// 		applyPureReactInVue(ReactSimpleInput)
